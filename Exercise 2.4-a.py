...
l = 1.0
m = 1.0
theta1 = [0.0, 0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.007, 0.008, 0.009, 0.01]
theta20 = 0.01
dt = 0.001
tmax = 20.0
nsteps =  int(tmax / dt)
...
# Using Euler-Cromer method to integrate the equations for double pendulum
    ...
    label = theta10 / theta20
     #Plotting results - Angle vs theta
    pylab.figure()
    pylab.title('Double pendulum - theta1/theta2 = %f'% label)
    ...
    pylab.legend(loc=9)
    pylab.grid()
    # Plotting results - Lissajous curves
    pylab.figure(figsize=(6,6))
    pylab.title('Lissajous curves - theta1/theta2 = %f'% label) 
    pylab.plot(q1, q2)
    ...
    pylab.grid()
    #Plotting results - trace
    pylab.figure(figsize=(6,6))
    pylab.title('Double pendulum trace - theta1/theta2 = %f ' % label)
    pylab.plot(x2, y2)
    pylab.xlabel('x (m)')
    pylab.ylabel('y (m)')
    pylab.grid()
